  ...
  return (
    <div className={`col-span-5 blg:col-span-8 lg:col-span-6 bxl:col-span-13! bxl2:col-span-7! xl:col-span-4!  px-2.5 bsm2:px-6 sm:px-10 md:px-20 blg:px-0! lg:px-44  flex items-start sm:items-center justify-center  ${user?.role === 'admin' && "h-full"} `}>
      <div className={`w-full sm:w-xl lg:min-w-2xl flex flex-col items-center mt-10 sm:mt-0`}>
        ...
        <div className={`bg-white rounded-md  w-full px-3.5 sm:px-5  max-w-[500px] pt-[58px] sm:pt-[68px] pb-6 sm:pb-7 flex items-center justify-center border border-gray-300  ${user?.role === 'admin' ? "shadow-none" : "shadow-lg"}   relative`}>
          <form className='flex flex-col items-center w-full' onSubmit={handleSubmit}>
            ...
            <div className='flex flex-col sm:flex-row items-start sm:items-center gap-0.5 sm:gap-5 w-full'>
              ...
              <input type="text" name="" id="name" value={name} onChange={(e) => setName(e.target.value)} className='text-[13px] font-[300] bg-gray-100 w-full p-2 px-3 border border-gray-300 rounded-sm outline-none' />
            </div>
            <div className='flex flex-col sm:flex-row items-start sm:items-center gap-0.5 sm:gap-5 mt-4 sm:mt-6 w-full'>
              ...
              <input type="email" name="" id="email" value={user?.email || ""} readOnly className='text-[13px] font-[300] bg-gray-100 w-full p-2 px-3 border border-gray-300 rounded-sm outline-none' />
            </div>
