...
const CoursesDataGrid = () => {
    ...
    const columns = [
        ...
        { field: " ", headerName: "Edit", flex: 0.4, renderCell: (params) => { return (<Button><RiEditBoxFill size={17} className='text-dark-green' /></Button>) } },
        { field: "  ", headerName: "Delete", flex: 0.4, renderCell: (params) => { return (<Button><AiFillDelete size={17} className='text-dark-green' /></Button>) } },
