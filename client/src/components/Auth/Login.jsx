                ...
                <div className='flex flex-col '>
                    ...
                    <div className='px-7 py-5'>
                        <form className='flex flex-col gap-4.5' onSubmit={handleSubmit}>
                            ...
                            <div>
                                <input type="submit" value={isLoading ? "Logging in..." : "Login"} disabled={isLoading}  className={`bg-grass-green text-white w-full py-1.5 rounded-md hover:bg-dark-grass-green ${isLoading ? "cursor-not-allowed" : "cursor-pointer"} outline-none focus:outline-none`}/>
                            </div>
                            ...
                            <div className='mt-3 flex flex-col gap-2.5 items-center'>
                                ...
                                <p className='text-sm font-[300] mt-3'>Are you a new user? <span className='font-[500] text-dark-grass-green hover:underline cursor-pointer' onClick={() => setActiveModal('signup')}>SignUp</span></p>
                            </div>
