    ...
    return (
        <div className='pb-18 pt-12 md:py-18'>
            <div className='flex flex-col-reverse md:flex-row md:gap-0 lg:gap-12 mx-auto max-w-7xl '>
                <div className='px-3 xs:px-4 flex items-center xl:items-start'>
                    <div className='flex flex-col gap-5 xs:gap-6 md:gap-4 lg:gap-5 xl:gap-7'>
                        <h1 className='text-[2.9rem]/12 xs:text-[3.2rem] bmd:text-[3.5rem] md:text-[2.8rem]/11 blg:text-[3.2rem]/13! lg:text-[3.7rem] bxl:text-[3.9rem]/15! xl:text-[5.5rem]/23! md:text-left text-center'>Elevate Your Mind, Discover Your <span className='text-grass-green'>Nirvana</span>.</h1>
                        <p className='text-center md:text-left text-sm sm:text-base md:text-sm blg:text-base! font-light w-[97%] lg:w-full self-center text-gray-800'>Embark on a journey of self-improvement with Elevana, where learning and growth come together to help you reach new heights.</p>
                ...
                <div className='px-3 bsm:px-5 bsm2:px-6 sm:px-8 bmd:px-20 md:px-2'>
