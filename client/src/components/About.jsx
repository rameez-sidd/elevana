      ...
      <div className='mx-auto max-w-7xl w-full'>
        <div className='flex gap-18 '>
          ...
          <div className='flex flex-col gap-10 items-center justify-center'>
            ...
            <p className='text-justify'><span className='text-xl font-[600]'>At Elevana</span>, we believe education is the key to personal and collective growth. Our mission is to provide a space where learning is accessible, empowering, and rewarding for both students and educators.
              <br/>
              <br/>
