...
const About = () => {
  ...
  return (
    <div className={`${user && user?.role === 'admin' ? 'bg-light-green' : 'bg-background-green'} pb-14 md:px-4 md:pt-14 xl:px-0 min-h-screen flex items-center`} id='about'>
      <div className='mx-auto max-w-7xl w-full'>
        <div className='flex flex-col md:flex-row gap-10 md:gap-0 xl:gap-18 '>
          ...
          <div className='flex flex-col px-2 xs:px-2.5 sm:px-3.5 md:pl-6 md:pr-2 xl:pr-6 2xl:px-0 gap-5 sm:gap-7 md:gap-6 lg:gap-10 items-center justify-center'>
            <div className='flex flex-col gap-0 sm:gap-1.5 md:gap-2'>
              <h3 className='text-center text-[23px] sm:text-2xl md:text-3xl lg:text-4xl font-[700]'>Inside <span className='text-grass-green'>Elevana</span></h3>
